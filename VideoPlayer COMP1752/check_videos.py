...
class CheckVideos():
    def __init__(self, window):
        ...
        play_playlist_btn.grid(row=3, column=0, padx=10, pady=10)
    ...
    def play_playlist(self):
        for video in self.playlist:  
            lib.increment_play_count(video)  
        self.status_lbl.configure(text="Playlist played! Play counts incremented.")  
